...
switch ($Feed) {
    /* case('products'):
         $Read->exeRead(DB_PDT_TRAVI, "WHERE pdt_inventory >= 1 AND pdt_status = 1 ORDER BY pdt_created DESC");
         if ($Read->getResult()):
             foreach ($Read->getResult() as $ReadPdt):
                 ...
                 $Read->linkResult(DB_PDT_CATS_TRAVI, "cat_id", $ReadPdt['pdt_subcategory'], 'cat_title');
