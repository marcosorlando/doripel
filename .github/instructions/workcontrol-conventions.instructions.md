...
- helpers legados (Call to undefined function) devem migrar para `App\Helpers\Check` encontrar metodo equivalente (nome)
  e corrigir
...
- preferir `require __DIR__ . '/../../vendor/autoload.php';` no lugar de includes legados de bootstrap, quando a
  estrutura do módulo for compatível
