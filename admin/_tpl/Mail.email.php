...
if (!\file_exists(__DIR__.'/../dashboard.json')) {
    $LicenseCheckMail = "<p style='font-size: 0.8rem; color: red;'>ATENÇÃO: Esse versão do Zen Control® não foi licenciada. Utilizar esse software sem licença é crime. Entre em contato via agencia@zen.ppg.br para maiores esclarecimentos!</p>";
} else {
