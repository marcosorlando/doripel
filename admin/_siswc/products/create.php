	...
	<form class="auto_save" name="manage_pdt" action="" method="post" enctype="multipart/form-data">
                    ...
                    <?php
                        foreach ($ProductOptionals as $OptionalIndex => $Optional) { ?>
							<div class="j_pdt_optional_item" data-optional-index="<?= $OptionalIndex; ?>">
								...
								<div class="label_50">
									<label class='label'>
										<span class='legend'>Imagem do Opcional: (Largura 600px)</span>
										<input type='hidden'
		...
		<aside class="box box30">
			...
			<div class="panel_header default">
				...
				<label class='label'>
					<span class='legend'>Ambientada <b>(WEBP 1920x1152px)</b>:</span>
				...
				<label class='label'>
					<span class='legend'>Imagem principal <b>(WEBP 1200x1200px)</b>:</span>
				...
				<label class="label">
					<span class="legend">Fotos Adicionais <b>(WEBP 1200x1200px)</b>:</span>
