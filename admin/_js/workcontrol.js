...
$(function () {
        ...
        if ($(window).outerWidth() < '480') {
            $.getScript('../assets/jquery.mobile.js', function () {
                ...
                success: function (data) {
                    ...
                    form.find('.form_load').fadeOut('slow', function () {
                        ...
                        if (data.field) {
                            ...
                            $('input, select, textarea').removeClass('form_error');
                            $('input, select, textarea').addClass('form_success');
                        }
        ...
        $('html, body').on('click', '.j_delete_action_confirm', function (e) {
            ...
            $.post('_ajax/' + Callback + '.ajax.php', {
                ...
                $('.workcontrol_upload').fadeOut();
                Trigger("<div class='trigger trigger_error ajax_close'><b>Erro:</b> não foi possível concluir a requisição.</div>");
            });
