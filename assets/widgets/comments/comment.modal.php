    ...
    <div class='comment_login_content'>
        ...
        <form name='comment_login' class="ajax_off wc_comment_login" action="" method="post"
            ...
            <div class="comment_login_actions">
                ...
                <img class="load" alt="Enviando Comentário" title="Enviando Comentário" src="<?php
                echo BASE; ?>/assets/widgets/comments/load_g.gif">
            </div>
        </form>
    </div>
</article>
