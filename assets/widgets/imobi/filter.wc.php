...
echo BASE; ?>/assets/widgets/imobi/filter.wc.css"/>
<script src="<?php
echo BASE; ?>/assets/widgets/imobi/filter.wc.js"></script>
...
<article class="wc_imobi_filter">
    ...
    <div class="content">
        ...
        <form class="wc_imobi_filter_form" name="wc_imobi_filter" action="" method="post" enctype="multipart/form-data">
            ...
            </select><a class="btn btn_green" href="<?php
            echo BASE; ?>/filtro" title="Filtrar Imóveis">BUSCAR!</a>
        </form>
        <div class="clear"></div>
    </div>
</article>
