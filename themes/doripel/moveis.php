  ...
  <div class="container">
    <div class="row">
      <main class="col-md-9 col-sm-12 col-xs-12 right-sidebar sm-margin-60px-bottom xs-margin-40px-bottom no-padding-left sm-no-padding-right">
          ...
          if (!$Read->getResult()):
              $Pager->ReturnPage();
              echo Erro("Ainda Não existe produtos cadastrados nesta seção. Por favor volte mais tarde :)",
                E_USER_NOTICE);
          else:
...
//      if (!$Read->getResult()):
//          $Pager->ReturnPage();
//          echo Erro("Ainda Não existe produtos cadastrados nesta seção. Por favor volte mais tarde :)", E_USER_NOTICE);
//      else:
//          foreach ($Read->getResult() as $Post):
//              extract($Post);
//              $BOX = 2;
