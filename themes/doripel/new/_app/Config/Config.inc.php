<?php
    ...
    if (!$WorkControlDefineConf):
        ...
        if ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == 'www.localhost'):
            define('BASE', 'https://localhost/doripel'); //Url raiz do site no localhost
        else:
            define('BASE', 'https://doripel.com.br'); //Url raiz do site no servidor
        endif;
        define('THEME', 'doripel'); //template do site
    endif;
    ...
    if (!$WorkControlDefineConf):
         ...
         */
        define('MAIL_HOST', 'smtp.kinghost.net'); //Servidor de e-mail
        define('MAIL_PORT', '465'); //Porta de envio
        define('MAIL_USER', 'doripel@doripel.com.br'); //E-mail de envio
        define('MAIL_SMTP', 'doripel@doripel.com.br'); //E-mail autenticador do envio (Geralmente igual ao MAIL_USER, exceto em serviços como AmazonSES, sendgrid...)
        define('MAIL_PASS', 'D0r!p3l@2019'); //Senha do e-mail de envio
        define('MAIL_SENDER', 'Doripel Móveis'); //Nome do remetente de e-mail
        ...
        define('SLIDE_H', 1080); //Tamanho da minuatura (HEIGHT) SLIDE
        ...
        */
        ...
        define('APP_DEPOSITIONS', 0); //Depoimentos
        define('APP_ALBUMS', 0); //Albuns de Fotos
        define('APP_PRODUCTS_DORIPEL', 1); //Produtos Doripel
        ...
        define('APP_CTAS', 1); //Widget Leads!
        ...
        define('LEVEL_WC_VIDEOS', 6);
        define('LEVEL_WC_DEPOSITIONS', 6);
        define('LEVEL_WC_ALBUMS', 6);
        define('LEVEL_WC_PRODUCTS_DORIPEL', 6);
        define('LEVEL_WC_HELLO', 6);
        define('LEVEL_WC_LANDING_PAGES', 6);
        define('LEVEL_WC_THANKYOU_PAGES', 6);
        ...
        define('SEGMENT_GL_ANALYTICS_UA', 'UA-134175755-1'); //ID do Google Analytics (UA-00000000-0)
