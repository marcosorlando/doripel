        ...
        <div class="row equalize xs-equalize-auto">
            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 display-table">
                <div class="display-table-cell vertical-align-middle text-left xs-text-center">
                    <!-- start page title -->
                    <h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin-bottom text-uppercase">Fale com a
                        Doripel</h1>
                    <!-- end page title -->
                </div>
            </div>
...
<section class="no-padding bg-extra-dark-gray">
    <div class="container-fluid">
        <div class="row equalize sm-equalize-auto">
            <div class="col-md-6 col-sm-12 no-padding cover-background sm-height-450px xs-height-350px wow fadeInLeft" style="background: url(<?= INCLUDE_PATH; ?>/images/sac-doripel.jpg)"></div>
            <div class="col-md-6 col-sm-12 no-padding col-2-nth wow fadeInRight">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 display-table bg-extra-dark-gray height-350px last-paragraph-no-margin">
                    <div class="display-table-cell vertical-align-middle text-center">
                        ...
                        <div class="text-white text-uppercase alt-font font-weight-600 margin-5px-bottom">Endereço</div>
                        <p class="width-60 md-width-80 center-col text-medium">Av. Julio Vanzin, 1600 - Área Industrial Lagoa Vermelha - RS - Brasil</p>
                    </div>
                </div>
                <!-- end contact item -->
                <!-- start contact item -->
                <div class="col-md-6 col-sm-6 col-xs-12 display-table bg-black height-350px last-paragraph-no-margin">
                    <div class="display-table-cell vertical-align-middle text-center">
                        ...
                        <div class="text-white text-uppercase alt-font font-weight-600 margin-5px-bottom">Faça uma chamada</div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 display-table bg-black height-350px last-paragraph-no-margin">
                    <div class="display-table-cell vertical-align-middle text-center">
                        ...
                        <div class="text-white text-uppercase alt-font font-weight-600 margin-5px-bottom">Nosso E-mail</div>
                        ...
                        <p class="center-col text-medium text-extra-light-gray">
                            <a class="contact-link"  href="mailto:assistencia@doripel.com.br">assistencia@doripel.com.br</a>
                        </p>
                    </div>
                </div>
                <!-- end contact item -->
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 display-table bg-extra-dark-gray height-350px last-paragraph-no-margin">
                    <div class="display-table-cell vertical-align-middle text-center">
                        ...
                        <div class="text-white text-uppercase alt-font font-weight-600 margin-5px-bottom">Horário de Trabalho</div>
    ...
    <div class="container">
        ...
        <form action="" class="animated fadeIn" method="post" enctype="multipart/form-data" novalidate="true">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <input type="text" name="nome" value="<?= isset($Contato['nome']) ? $Contato['nome'] : ''; ?>" placeholder="Nome*" class="big-input" required>
                </div>
                <div class="col-md-6">
                    <input type="text" name="assunto" value="<?= isset($Contato['assunto']) ? $Contato['assunto'] : ''; ?>" placeholder="Assunto*" class="big-input" required>
                </div>
                <div class="col-md-6">
                    <input type="email" name="email" value="<?= isset($Contato['email']) ? $Contato['email'] : ''; ?>" placeholder="E-mail*" class="big-input" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <textarea name="mensagem" placeholder="Sua mensagem*" rows="6" class="big-textarea" required><?= isset($Contato['mensagem']) ? $Contato['mensagem'] : ''; ?></textarea>
                </div>
                <div class="col-md-12 text-center">
                    <button type="submit" class="btn btn-medium btn-deep-pink">
                        <i class="fa fa-envelope-open"></i> Enviar Mensagem
                        <img class="form_load none" style="margin-left: 10px; display: none;" alt="Enviando Requisição!" title="Enviando Requisição!" src="<?= INCLUDE_PATH; ?>/images/icons/load.gif" data-no-retina="">
                    </button>
                </div>
            </div>
    </div>
